...
const schema = Joi.object({
    ...
    swaggerDirPath: Joi.string().allow( null ),
    publicDirPath: Joi.string().allow( null ),
}).unknown();
...
exports.register = function (plugin, options, next) {
    ...
    const publicDirPath = options.publicDirPath||(__dirname + Path.sep + '..' + Path.sep + 'public');
...
console.log('swaggerDirPath', swaggerDirPath)
console.log('-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-')
