...
class Select extends React.Component{
  getValue(){
    if(this.props.multiple){
      var values = [].filter.call(this.refs.editor.options, function (o) {
        return o.selected;
      }).map(function (o) {
        return o.value;
      });
  ...
  render(){
    const inputProps = Object.keys(this.props).reduce((obj, key)=>{
      ...
      if(key === 'value'){
        obj.defaultValue = this.props.mapValues?this.props.mapValues(this.props.value):this.props.value;
        return obj;
      }
      if(key === 'items'){
        return obj;
